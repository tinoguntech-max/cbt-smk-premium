...
Write-Host "  Upload LMS CBT ke VPS $VPS_IP (pts.smknegeri1kras.sch.id)" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "     chmod +x deploy-fresh-ubuntu24-pts.sh" -ForegroundColor Cyan
Write-Host "     bash deploy-fresh-ubuntu24-pts.sh" -ForegroundColor Cyan
Write-Host ""
Write-Host "============================================================" -ForegroundColor Cyan
